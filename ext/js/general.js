...
function makeCollapsible() {
    var collaps = document.createElement( 'ul' );
    collaps.className = 'collapsible';
    $( collaps ).attr( 'data-collapsible', 'expandable' );
    ...
    var bod = "  <li>\
              ...
              <li>\
                <div class=\"collapsible-header\">\
                  ...
                  Wyniki poszczególnych kompilacji\
                <div class=\"collapsible-body\"><p>Lorem ipsum dolor sit amet.</p></div>\
              </li>\
              <li>\
                <div class=\"collapsible-header\">\
    ...
    $( collaps ).html( bod );
    var where = "body > div.card-panel.blue-grey.lighten-4 > table.testerka-srodek > tbody > tr > td:nth-child(2) > div > table > tbody > tr:nth-child(6) > td";
    var table = document.getElementsByClassName("testerka-tresc");

    $( where ).append( collaps );
...
function init() {
    if (!__isuptodate) {
        ...
        if (__current_href.match("SubmitDetails") !== null) {
            setTimeout(hideLogs, 350);
            setTimeout(codeHighlight, 350);
        }
